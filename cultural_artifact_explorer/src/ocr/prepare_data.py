...
LABELS_DIR = "/Users/paarthmiglani/PycharmProjects/manualagent/imagestext"
OUT_CSV = "data/ocr/annotations.csv"
...
# Save character list
with open("data/ocr/char_list.txt", "w", encoding="utf-8") as f:
